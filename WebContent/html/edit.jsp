...
<table width="1134" border="0" cellspacing="0" cellpadding="0" align="center">
  <tbody><tr>
	...
	<td  ><img src="./images/title/title_free.png"></td>
  </tr>
 </tbody>
</table>
...
<form action="./edit_ok.ap" method="post">
<table width="1134" border="0" cellspacing="0" cellpadding="0" class="boardWrite" style="margin-top:15px;" align="center">
	<tbody><tr><input type="hidden" name="num" value="<%=num %>">
		<th width="123">제목</th>
		<td width="807" class="title"><input type="text" name="title" id="title" class="input6" value="<%=dto.getTitle() %>"></td>
	</tr>
	<tr>
		<th>작성자</th>
		<td class="title" align="left"><strong><%=dto.getName() %></strong></td>
	</tr>
	<tr>
		<th style="vertical-align:top; padding-top:9px;">내용</th>   <!-- 이거안됨 -->
		<td class="content"><textarea name="board" id="board" cols="25" rows="15" class="board" ><%=dto.getBoard() %></textarea></td>
...
<table align="center">
<td>
<button id="join1-btn"  type="submit" value="1" border="0" class="ui_btn_red" >등록</td> <td><a href="./board.ap" id="join-btn" class="ui_btn_gray">돌아가기</a> </td>
</table>						  
 </form>
